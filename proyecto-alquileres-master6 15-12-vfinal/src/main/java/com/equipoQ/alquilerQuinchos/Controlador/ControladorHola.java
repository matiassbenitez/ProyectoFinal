...
//    al cambiar a login el return funciona el perfil. puede ser por un tema de la clase seguridad web u otro tema.
      return "inicio";
   }
   ...
   public String notificaciones(ModelMap modelo, HttpSession session) {
      Usuario usuario = (Usuario) session.getAttribute("usuariosession");
      modelo.put("usuario", usuario);
      return "notificaciones";
   }
         @GetMapping("/reservas")
   public String reservas(ModelMap modelo, HttpSession session) {
      Usuario usuario = (Usuario) session.getAttribute("usuariosession");
      modelo.put("usuario", usuario);
      return "misreservas";
   }
